...
class Main {
    ...
    public static void main(String[] args) {
        ...
        w = new Ware ("03073073", "Reifen", 33.00, Warengruppe.WERKZEUG);
        katalog.fuegeWareEin(w);

        w = new Ware ("03073074", "Schlauch", 8.00, Warengruppe.WERKZEUG);
        katalog.fuegeWareEin(w);

        w = new Ware ("03073103", "Luftpumpe", 13.00, Warengruppe.WERKZEUG);
        katalog.fuegeWareEin(w);
